<?php $this->load->view('back/meta') ?>
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="box-body">
								<a href="<?php echo base_url('admin/subkategori/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
  ...
  $(document).ready(function() {
    table = $('#datatable').DataTable({
      ...
      "ajax": {
        "url": "<?php echo site_url('admin/subkategori/ajax_list')?>",
        "type": "POST"
      },
