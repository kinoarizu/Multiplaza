...
<div class="container">
    ...
    <div class="col-lg-12"><h1>Tracking List</h1><hr>
			<div class="row">
			  <div class="col-lg-12">
                  ...
                  <td style="text-align:center"><?php echo strtoupper($history->kurir).' '.$history->service ?></td>
                    ...
                    elseif($history->status == '2'){ ?>
		                ...
		                <?php } ?>
									...
									<td style="text-align:center">
                    <a href="<?php echo base_url('tracking/tracking_detail/'.$history->resi ) ?>">
                      <button name="update" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-zoom-in"></i> Lihat Tracking</button>
                    </a>
                  </td>
                </tr>
              <?php } ?>
